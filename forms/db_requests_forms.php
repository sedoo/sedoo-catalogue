...
class db_requests_forms extends login_form
{
    ...
    function display()
    {
        ...
        foreach ($this->requetes as $r) {
            ...
            if ($this->isAdmin) {
                echo "<td rowspan='2' style='white-space : nowrap;'>$r->mail</td>";
            }
