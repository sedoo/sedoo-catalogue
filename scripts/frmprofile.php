...
if ($form->isLogged()) {
    ...
    if ($pageId == 1) {
        ...
        } elseif ((array_key_exists(strtolower($form_user->project[0]) . 'ApplicationDate', $form->user->attrs[strtolower($form_user->project[0])]) && $form->user->attrs[strtolower($form_user->project[0]) . 'Status'][0] == 'pending') || (array_key_exists(strtolower($form_user->project[0]) . 'ApplicationDate', $form->user->attrs) && $form->user->attrs[strtolower($form_user->project[0]) . 'Status'][0] == 'pending')) {
        ...
        } elseif ((array_key_exists(strtolower($form_user->project[0]) . 'ApplicationDate', $form->user->attrs[strtolower($form_user->project[0])]) && $form->user->attrs[strtolower($form_user->project[0]) . 'Status'][0] == 'rejected') || (array_key_exists(strtolower($form_user->project[0]) . 'ApplicationDate', $form->user->attrs) && $form->user->attrs[strtolower($form_user->project[0]) . 'Status'][0] == 'rejected')) {
