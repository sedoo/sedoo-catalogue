...
class ElasticSearchUtils
{
    ...
    public static function lstQueryData($query, $projectName)
    {
    ...
    public static function printDataset($datsId, $datsTitle, $withInsertedData, $projectName, $queryArgs = array(), $withTitle = false)
    {
    ...
    public static function getMultipleInsertedDatsLink($searchDatsIds, $projectName, $queryArgs = array())
    {
    ...
    public static function printLegende($projectName, $searchDatsIds = array(), $queryArg = array())
    {
        $legende = array ();
    ...
    public static function getDataNodeConf($datsId, $datsTitle, $withInsertedData, $projectName, $queryArgs = array())
    {
    ...
    public static function addBackToSearchResultLink()
    {
